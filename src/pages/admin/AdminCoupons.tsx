  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-slate-900 mb-2">إدارة الكوبونات العروض</h1>
          <p className="text-slate-500">إضافة وتعديل كوبونات الخصم والتي ستظهر في أعلى الموقع إذا كانت مفعلة</p>
        </div>
        <button 
