      ...
      {loading ? (
        ...
        >
          <div className="w-24 h-24 bg-rose-50 rounded-full flex items-center justify-center mb-8">
            <ArrowLeft className="w-12 h-12 text-rose-600 rotate-90" />
          </div>
          ...
          <Link to="/" className="text-rose-600 font-bold hover:underline">
            العودة للرئيسية
          </Link>
        </motion.div>
      ) : (
              ...
              <div className="p-6 flex-1 flex flex-col">
                ...
                <div className="mt-auto pt-6 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <Link 
                    ...
                    className="flex items-center gap-2 text-rose-600 font-medium hover:text-rose-700 transition-colors"
                  >
